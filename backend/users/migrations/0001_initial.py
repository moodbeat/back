    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar_full', models.ImageField(blank=True, null=True, upload_to='users/avatars/', verbose_name='Аватар/Фото')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=128, validators=[django.core.validators.MinLengthValidator(2)], verbose_name='Наименование')),
                ('description', models.TextField(blank=True, max_length=512, null=True, verbose_name='Описание')),
                ('level', models.PositiveSmallIntegerField(choices=[(1, 'Норма'), (2, 'Плохо'), (3, 'Критический уровень')], default=1, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(3)], verbose_name='Уровень')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='user',
            name='mental_state',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='employees', to='users.mentalstate', verbose_name='Психологическое состояние'),
        ),
        migrations.AddField(
            model_name='user',
            name='position',
