# Generated by Django 4.2.1 on 2023-06-10 13:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("summary", models.JSONField(verbose_name="Сводка")),
                (
                    "questions",
                    models.JSONField(default=None, null=True, verbose_name="Вопросы"),
                ),
                ("results", models.JSONField(verbose_name="Выбранные варианты")),
                (
                    "completion_date",
                    models.DateField(
